(self["webpackChunk_hydrooj_ui_default"] = self["webpackChunk_hydrooj_ui_default"] || []).push([["n.vditor"],{
...
onclick="this.previousElementSibling.select();document.execCommand('copy');this.setAttribute('aria-label', '` + ((null === (a = window.VditorI18n) || void 0 === a ? void 0 : a.copied) || "\u5DF2\u590D\u5236") + `')">` + d + "</span>";
    ...
    var r2 = n2(54), i = n2(526), o = n2(156), a = function(e3, t3, n3) {
      ...
      0 !== a2.length && (0, i.G)(t3 + "/dist/js/mermaid/mermaid.min.js?v=10.8.0", "vditorMermaidScript").then(function() {
      ...
      if (e3)
        if ("html-block" !== e3.parentElement.getAttribute("data-type")) {
          ...
          if ("abc" === n2)
            ...
            }) || ((0, T.s)(Object.assign({}, t3.options.preview.hljs), e3, t3.options.cdn), (0, S.O)(e3, t3.options.preview.hljs));
          }
    ...
    var Z, J, X = function(t3) {
      ...
      clearTimeout(e3.wysiwyg.hlToolbarTimeoutId), e3.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function() {
        if ("false" !== e3.wysiwyg.element.getAttribute("contenteditable") && (0, D.Gb)(e3.wysiwyg.element)) {
          ...
          var v2 = (0, y.lG)(n2, "A");
          v2 && u(e3.toolbar.elements, ["link"]);
          var h2 = (0, y.lG)(n2, "TABLE"), g2 = (0, b.W)(n2);
          (0, y.lG)(n2, "CODE") ? (0, y.lG)(n2, "PRE") ? (m(e3.toolbar.elements, ["headings", "bold", "italic", "strike", "line", "quote", "list", "ordered-list", "check", "code", "inline-code", "upload", "link", "table", "record"]), u(e3.toolbar.elements, ["code"])) : (m(e3.toolbar.elements, ["headings", "bold", "italic", "strike", "line", "quote", "list", "ordered-list", "check", "code", "upload", "link", "table", "record"]), u(e3.toolbar.elements, ["inline-code"])) : g2 ? (m(e3.toolbar.elements, ["bold"]), u(e3.toolbar.elements, ["headings"])) : h2 && m(e3.toolbar.elements, ["table"]);
          var w2 = (0, y.fb)(n2, "vditor-toc");
          if (w2)
            return e3.wysiwyg.popover.innerHTML = "", ue(w2, e3), void le(e3, w2);
          var E2 = (0, b.S)(n2, "BLOCKQUOTE");
          if (E2 && (e3.wysiwyg.popover.innerHTML = "", de(t3, E2, e3), ce(t3, E2, e3), ue(E2, e3), le(e3, E2)), o2 && (e3.wysiwyg.popover.innerHTML = "", de(t3, o2, e3), ce(t3, o2, e3), ue(o2, e3), le(e3, o2)), h2) {
            e3.options.lang, e3.options;
            e3.wysiwyg.popover.innerHTML = "";
            var k2 = function() {
              var t4 = h2.rows.length, n3 = h2.rows[0].cells.length, r3 = parseInt(P2.value, 10) || t4, i2 = parseInt(B2.value, 10) || n3;
              if (r3 !== t4 || n3 !== i2) {
                if (n3 !== i2)
                  for (var o3 = i2 - n3, l3 = 0; l3 < h2.rows.length; l3++)
                    if (o3 > 0)
                      for (var s3 = 0; s3 < o3; s3++)
                        0 === l3 ? h2.rows[l3].lastElementChild.insertAdjacentHTML("afterend", "<th> </th>") : h2.rows[l3].lastElementChild.insertAdjacentHTML("afterend", "<td> </td>");
                    else
                      for (var d2 = n3 - 1; d2 >= i2; d2--)
                        h2.rows[l3].cells[d2].remove();
                if (t4 !== r3) {
                  var c2 = r3 - t4;
                  if (c2 > 0) {
            ...
            J2.appendChild(P2), P2.type = "number", P2.min = "1", P2.className = "vditor-input", P2.style.width = "42px", P2.style.textAlign = "center", P2.setAttribute("placeholder", window.VditorI18n.row), P2.value = h2.rows.length.toString(), P2.oninput = function() {
              k2();
            ...
            q2.appendChild(B2), B2.type = "number", B2.min = "1", B2.className = "vditor-input", B2.style.width = "42px", B2.style.textAlign = "center", B2.setAttribute("placeholder", window.VditorI18n.column), B2.value = h2.rows[0].cells.length.toString(), B2.oninput = function() {
              k2();
            }, B2.onkeydown = function(n3) {
              if (!n3.isComposing)
                return "Tab" === n3.key ? (P2.focus(), P2.select(), void n3.preventDefault()) : void (oe(e3, n3) || fe(n3, t3));
            }, de(t3, h2, e3), ce(t3, h2, e3), ue(h2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", C2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", A2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", _2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", H2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", x2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", I2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", O2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", j2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", R2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", J2), e3.wysiwyg.popover.insertAdjacentHTML("beforeend", " x "), e3.wysiwyg.popover.insertAdjacentElement("beforeend", q2), le(e3, h2);
          }
          ...
          if (v2 && me(e3, v2, t3), !(E2 || o2 || h2 || G2 || v2 || V2 || U2 || g2 || w2)) {
      ...
      t3.addEventListener("dragstart", function(e4) {
        ...
        t4.dataTransfer.getData(i.g.DROP_EDITOR) ? ct(e3) : (t4.dataTransfer.types.includes("Files") || t4.dataTransfer.types.includes("text/html")) && Tt(e3, t4, { pasteCode: function(e4) {
      ...
      t3.addEventListener("keydown", function(t4) {
        if (!t4.isComposing && e3.options.keydown && e3.options.keydown(t4), !(e3.options.hint.extend.length > 1 || e3.toolbar.elements.emoji) || !e3.hint.select(t4, e3)) {
          if (e3.options.comment.enable && "wysiwyg" === e3.currentMode && ("Backspace" === t4.key || P("\u2318X", t4)) && e3.wysiwyg.getComments(e3), "sv" === e3.currentMode) {
            ...
            }), !Mt(t5, k2, n3))) && (Ye(n3, t5.key), !k2 || !j(k2, e4, t5, n3) || (t5.preventDefault(), 0)));
          }(e3, t4))
            return;
      ...
      function e3(e4) {
        ...
        t3.className = "vditor-ir", t3.innerHTML = '<pre class="vditor-reset" placeholder="' + e4.options.placeholder + '"\n contenteditable="true" spellcheck="false"></pre>', this.element = t3.firstElementChild, this.bindEvent(e4), Se(e4, this.element), Le(e4, this.element), Me(e4, this.element), xe(e4, this.element), He(e4, this.element), Te(e4, this.element), Ce(e4, this.element, this.copy), Ae(e4, this.element, this.copy);
      }
      return e3.prototype.copy = function(e4, t3) {
        ...
        this.element.addEventListener("paste", function(t4) {
          Tt(e4, t4, { pasteCode: function(e5) {
...
<script src="` + e5.options.cdn + "/dist/js/icons/" + e5.options.icon + '.js"><\/script></body></html>';
      ...
      return e3.prototype.merge = function() {
        ...
        var a2 = (0, Gn.T)(this.defaultOptions, this.options);
      ...
      return e3.prototype.getComments = function(e4, t3) {
        ...
        this.unbindListener(), window.addEventListener("scroll", this.scrollListener = function() {
          ...
          Tt(e4, t4, { pasteCode: function(t5) {
