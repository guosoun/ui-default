...
/* harmony export */ });
/* unused harmony exports tail, tail2, removeFastWithoutKeepingOrder, binarySearch, binarySearch2, quickSelect, groupBy, coalesce, coalesceInPlace, isFalsyOrEmpty, isNonEmptyArray, distinct, firstOrDefault, range, pushToStart, pushToEnd, asArray, insertInto, splice, CompareResult, tieBreakComparators, booleanComparator, ArrayQueue, CallbackIterable */
...
/* harmony export */ });
/* unused harmony exports findLast, findLastIdx, findFirstMaxBy, findLastMaxBy, findFirstMinBy, findMaxIdxBy, mapFindFirst */
...
/* harmony export */ });
/* unused harmony exports ok, softAssert */
...
/* harmony export */ });
/* unused harmony exports RGBA, HSVA */
...
/* harmony export */ });
/* unused harmony exports ErrorHandler, errorHandler, onUnexpectedExternalError, isCancellationError, CancellationError, canceled, illegalArgument, illegalState, NotSupportedError, ErrorNoTelemetry */
class ErrorHandler {
  constructor() {
    this.listeners = [];
...
/* harmony export */ });
/* unused harmony exports EventProfiling, createEventDeliveryQueue, PauseableEmitter, DebounceEmitter, MicrotaskEmitter, EventMultiplexer, EventBufferer, Relay */
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./errors.js */ "../../node_modules/monaco-editor/esm/vs/base/common/errors.js");
...
class Emitter {
  constructor(options) {
    ...
    this._leakageMon = _globalLeakWarningThreshold > 0 || ((_a = this._options) === null || _a === void 0 ? void 0 : _a.leakWarningThreshold) ? new LeakageMonitor((_c = (_b = this._options) === null || _b === void 0 ? void 0 : _b.leakWarningThreshold) !== null && _c !== void 0 ? _c : _globalLeakWarningThreshold) : void 0;
        ...
        if (_enableDisposeWithListenerWarning) {
          ...
          queueMicrotask(() => {
            forEachListener(listeners, (l) => {
              var _a2;
              return (_a2 = l.stack) === null || _a2 === void 0 ? void 0 : _a2.print();
            });
          });
        }
  ...
  get event() {
    ...
    (_a = this._event) !== null && _a !== void 0 ? _a : this._event = (callback, thisArgs, disposables) => {
      ...
      if (!this._listeners) {
        (_b = (_a2 = this._options) === null || _a2 === void 0 ? void 0 : _a2.onWillAddFirstListener) === null || _b === void 0 ? void 0 : _b.call(_a2, this);
...
/* harmony export */ });
/* unused harmony exports setDisposableTracker, trackDisposable, markAsDisposed, markAsSingleton, isDisposable, dispose, MutableDisposable, RefCountedDisposable, ImmortalReference, DisposableMap */
...
/* harmony export */ });
/* unused harmony exports ResourceMap, LinkedMap, LRUCache, BidirectionalMap */
var _a, _b;
...
/* harmony export */ });
/* unused harmony exports LANGUAGE_DEFAULT, isLinux, isNative, isWebWorker, webWorkerOrigin, isIOS, isMobile, userAgent, language, setTimeout0IsFaster, setTimeout0, OS, isLittleEndian, isChrome, isFirefox, isSafari, isEdge, isAndroid */
...
/* harmony export */ });
/* unused harmony exports isFalsyOrWhitespace, format, htmlAttributeEncodeValue, escape, trim, ltrim, rtrim, convertSimple2RegExpPattern, stripWildcards, regExpLeadsToEndlessLoop, getLeadingWhitespace, compare, compareSubstring, compareIgnoreCase, compareSubstringIgnoreCase, isAsciiDigit, isLowerAsciiLetter, equalsIgnoreCase, startsWithIgnoreCase, commonPrefixLength, commonSuffixLength, CodePointIterator, GraphemeIterator, nextCharLength, prevCharLength, getCharContainingOffset, containsRTL, UNUSUAL_LINE_TERMINATORS, containsUnusualLineTerminators, isFullWidthCharacter, isEmojiImprecise, UTF8_BOM_CHARACTER, startsWithUTF8BOM, containsUppercaseCharacter, singleLetterHash, getLeftDeleteOffset, noBreakWhitespace */
...
/* harmony export */ });
/* unused harmony exports isNumber, isIterable, isBoolean, isUndefined, isDefined, assertType, assertIsDefined, isFunction, validateConstraints, validateConstraint */
...
class LineRangeMapping {
  static inverse(mapping, originalLineCount, modifiedLineCount) {
    ...
    for (const m of mapping) {
      const r2 = new LineRangeMapping(new _core_lineRange_js__WEBPACK_IMPORTED_MODULE_0__.LineRange(lastOriginalEndLineNumber, m.original.startLineNumber), new _core_lineRange_js__WEBPACK_IMPORTED_MODULE_0__.LineRange(lastModifiedEndLineNumber, m.modified.startLineNumber));
...
/* harmony export */ });
/* unused harmony exports TokenizationResult, EncodedTokenizationResult, CompletionItemKinds, InlineCompletionTriggerKind, SelectedSuggestionInfo, SignatureHelpTriggerKind, DocumentHighlightKind, isLocationLink, symbolKindNames, getAriaLabelForSymbol, SymbolKinds, TextEdit, FoldingRangeKind, Command, InlayHintKind, LazyTokenizationSupport, TokenizationRegistry */
...
/* harmony export */ });
/* unused harmony exports OverviewRulerLane, GlyphMarginLane, MinimapPosition, InjectedTextCursorStops, TextModelResolvedOptions, isITextSnapshot, ValidAnnotatedEditOperation, ApplyEditsResult, shouldSynchronizeModel */
...
/* harmony export */ });
/* unused harmony exports localize2, setLocaleData, loadMessageBundle, config */
...
const getConfiguredDefaultLocale = () => "zh";
